...
urlpatterns = [
    ...
    path('adminaddtrainer',views.adminaddtrainer),
    path('adminaddtrainer_post',views.adminaddtrainer_post),
    path('view_attendence_post/<int:id>',views.view_attendence_post),
    path('view_students/<int:id>',views.view_students),
    ...
    path('view_both_post',views.view_both_post,name='view_both_post'),
    path('deletetrainerfromsystem/<int:id>',views.deletetrainerfromsystem,name='deletetrainerfromsystem'),
    ...
    path('add_dept_post',views.add_dept_post),
     ...
     path('view_stu_attendence/<int:id>',views.view_stu_attendence,name='view_stu_attendence'),
     path('view_stu_attendence_post/<int:id>',views.view_stu_attendence_post,name='view_stu_attendence_post'),
...
path('view_trainee_attendence_trainer/<int:id>',views.view_trainee_attendence_trainer,name='view_trainee_attendence_trainer'),
path('view_his_attendence',views.view_his_attendence),
path('view_his_attendence_post/<int:id>',views.view_his_attendence_post, name='view_his_attendence_post'),
...
path('view_class_sch',views.view_class_sch),
path('viewschedule_post/<int:id>',views.viewschedule_post),
path('view_attendence_trainee/<int:id>',views.view_attendence_trainee, name='view_attendence_trainee'),
path('view_attendence_trainee_post/<int:id>',views.view_attendence_trainee_post,name='view_attendence_trainee_post'),
...
path('view_attendencetrainee_post/<int:id>',views.view_attendencetrainee_post,name="view_attendencetrainee_post"),
...
path('view_downloads/<int:id>',views.view_downloads),
path('viewtprofile',views.viewtprofile),

path('view_upload/',views.view_upload),
path('download/<str:filepath>/',views.download),
# url(r'^download/(?P<path>.*)$',serve,{'document_root':settings.MEDIA_ROOT}),

# path('view_download/<id>',views)
]
